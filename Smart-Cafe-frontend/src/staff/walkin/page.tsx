  ...
  const handleGenerate = async () => {
    try {
      ...
      const result = await bookingService.createWalkinBooking({
        ...
        items: [],
        cashCollected: cashCollected ? Number(cashCollected) : 0,
      });
        ...
        {tokenGenerated ? (
          ...
          <>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none mb-6"
            />

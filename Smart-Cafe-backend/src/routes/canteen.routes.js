...
router.patch('/:id', authenticate, isManagement, canteenController.updateCanteen);
router.delete('/:id', authenticate, isManagement, canteenController.deleteCanteen);
router.patch('/:id/toggle', authenticate, isManagement, canteenController.toggleCanteenStatus);
router.patch('/:id/occupancy', authenticate, isManagement, canteenController.updateOccupancy);
